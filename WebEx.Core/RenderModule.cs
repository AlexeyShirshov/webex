...
namespace WebEx.Core
{
    ...
    public static class WebExHtmlRenderModuleExtensions
    {
        ...
        internal static MvcHtmlString RenderModuleInternal(this HtmlHelper helper, IModule module, IDictionary<string, object> args,
            IModuleView view, object model, string moduleInstanceId, CachedModule cm, string moduleFolder,
        ...
        public static MvcHtmlString RenderModule(this HtmlHelper helper, string moduleName, IModuleView view, object model = null,
            bool ignoreCase = false, string moduleInstanceId = null, IDictionary<string, object> args = null,
            IEnumerable<IPreRenderFilter> preRenderFilters = null,
            IEnumerable<IPostRenderFilter> postRenderFilters = null)
        {
            bool found;
            var r = helper.RenderModule(moduleName, args, out found, null, view, model, ignoreCase, moduleInstanceId, preRenderFilters, postRenderFilters);

            if (!found)
            {
                r = helper.RenderNonModule(moduleName, args, view, model, moduleInstanceId, preRenderFilters, postRenderFilters);
            }
            return r;
        }

        #region Render IModule
            ...
            IEnumerable<IPostRenderFilter> postRenderFilters = null)
        {
            ...
            return helper.RenderModuleInternal(module, args, view, model, moduleInstanceId, res as CachedModule, null, preRenderFilters, postRenderFilters);
        }

        public static MvcHtmlString RenderModule(this HtmlHelper helper, IModule module, 
            string view = null, object model = null, string moduleInstanceId = null,
            IEnumerable<IPreRenderFilter> preRenderFilters = null,
            IEnumerable<IPostRenderFilter> postRenderFilters = null)
        {
            if (module == null)
            ...
            foreach (var mview in module.GetViews(Contracts.DefaultView, view, helper))
            {
                var r = helper.RenderModule(module, null, mview, model, moduleInstanceId, preRenderFilters, postRenderFilters);
                if (r != null)
        ...
        public static MvcHtmlString RenderModule(this HtmlHelper helper, string moduleName, string viewType, string view, object moduleModel = null, string moduleInstanceId = null)
        {
            return helper.RenderModule(moduleName, (IDictionary<string, object>)null, view, moduleModel, false, moduleInstanceId, viewType: viewType);
        }
        ...
        public static MvcHtmlString RenderModule(this HtmlHelper helper, string moduleName, IDictionary<string, object> args,
            ...
            IEnumerable<IPreRenderFilter> preRenderFilters = null,
            IEnumerable<IPostRenderFilter> postRenderFilters = null,
            string viewType = Contracts.DefaultView)
        {
            bool found;
            var r = helper.RenderModule(moduleName, args, out found, null, view, moduleModel, ignoreCase, moduleInstanceId, preRenderFilters, postRenderFilters, viewType);

            if (!found)
            {
                r = helper.RenderNonModule(moduleName, args, view, moduleModel, moduleInstanceId, preRenderFilters, postRenderFilters, viewType);
            }
            return r;
        }
        private static MvcHtmlString RenderModule(this HtmlHelper helper, Type mt, CachedModule m, IDictionary<string, object> args, string moduleFolder,
            IModuleView view = null, object moduleModel = null,
        ...
        {            
            ...
            return helper.RenderModuleInternal(m.Inner, args, view, moduleModel, moduleInstanceId, m, moduleFolder, preFilters, postFilters);
                    
        }
        private static MvcHtmlString RenderModule(this HtmlHelper helper, string moduleName, IDictionary<string, object> args, out bool found, string moduleFolder,
            string view = null, object moduleModel = null,
            bool ignoreCase = false, string moduleInstanceId = null,
            IEnumerable<IPreRenderFilter> preRenderFilters = null,
            IEnumerable<IPostRenderFilter> postRenderFilters = null,
            ...
            if (mt != null)
            {
                ...
                if (mt != null && helper.GetStorage().TryGetValue(WebExModuleExtensions.MakeViewDataKey(mt), out res))
                {
                    ...
                    if (m != null)
                    {
                        ...
                        var sb = new StringBuilder();
                        foreach (var mview in m.GetViews(viewType, view, helper))
                        {
                            var r = helper.RenderModule(mt, m, args, moduleFolder, mview, moduleModel, moduleInstanceId, preRenderFilters, postRenderFilters);
                            if (r != null)
                                sb.Append(r.ToString());
                        }
            ...
            if (mt != null)
            {
                ...
                if (mt != null && helper.GetStorage().TryGetValue(WebExModuleExtensions.MakeViewDataKey(mt), out res))
                {
                    ...
                    if (m != null)
                    {
                        ...
                        return helper.RenderModule(mt, m, args, moduleFolder, view, moduleModel, moduleInstanceId, preRenderFilters, postRenderFilters);
                    }
                }
            }
        ...
        private static MvcHtmlString RenderNonModule(this HtmlHelper helper, string moduleName, IDictionary<string, object> args,
            string view = null, object moduleModel = null,
            string moduleInstanceId = null,
            IEnumerable<IPreRenderFilter> preRenderFilters = null,
            IEnumerable<IPostRenderFilter> postRenderFilters = null,
            string viewType = Contracts.DefaultView)
        {
            return helper.RenderNonModule(moduleName, args, new ModuleAutoView(viewType, view), moduleModel, moduleInstanceId, preRenderFilters, postRenderFilters);
        }
            ...
            IEnumerable<IPostRenderFilter> postRenderFilters = null)
        {
            ...
            if (module != null && helper.GetStorage().TryGetValue(WebExModuleExtensions.MakeViewDataKey(module), out res))
            {
                ...
                if (m != null)
                {
                    ...
                    var sb = new StringBuilder();
                    foreach (var mview in m.GetViews(Contracts.DefaultView, view, helper))
                    {
                        var r = helper.RenderModuleInternal(m.Inner, args, mview, null, moduleInstanceId, m, null, preFilters, postFilters);
                        if (r != null)
                            sb.Append(r.ToString());
                    }
        ...
        {
            var sb = new StringBuilder();
            foreach (var item in WebExHtmlExtensions._GetModules(helper.GetStorage()).Select(it => new { module = it, views = it.GetViews(viewType) }).
            ...
            IEnumerable<IPostRenderFilter> postRenderFilters = null)
        {
            ...
            foreach (var module in modules)
            {
                foreach (var mview in module.GetViews(Contracts.DefaultView, view, helper))
                {
                    var r = helper.RenderModule(module, args, mview, null, null, preRenderFilters, postRenderFilters);
                    if (r != null)
                        sb.Append(r.ToString());
                }
            }
            ...
            foreach (var rootFolder in folders)
            {
                ...
                if (System.IO.Directory.Exists(moduleRootPath))
                {
                    ...
                    foreach (var module in System.IO.Directory.EnumerateDirectories(moduleRootPath))
                    {
                        ...
                        var modulePath = System.IO.Path.Combine(moduleFolder, moduleName);
                        bool found;
                        var r = helper.RenderModule(moduleName, args, out found, modulePath, view, preRenderFilters: preRenderFilters, postRenderFilters: postRenderFilters, viewType: viewType);

                        if (!found)
                        {
                            r = helper.RenderNonModule(modulePath, args, view, preRenderFilters: preRenderFilters, postRenderFilters: postRenderFilters, viewType: viewType);
                        }
